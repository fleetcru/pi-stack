...
- `create-session-dialog.tsx` — thin Dialog shell around `QuickSessionComposer` (`variant="dialog"`, More options open by default) so "+" and empty-workspace create stay one component.
