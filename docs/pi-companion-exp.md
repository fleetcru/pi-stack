...
- `SessionsViewModel.kt` / `SessionsScreen.kt` — inventory listing with grouping. Each session list keeps 16 dp of scrollable space below its final row so cards do not touch the floating bottom navigation.
