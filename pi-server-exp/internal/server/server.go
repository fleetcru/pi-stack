...
func (s *Server) routes() http.Handler {
	...
	mux.HandleFunc("DELETE /v1/devices/{id}/purge", s.purgeDevice)
	mux.HandleFunc("GET /v1/admin/state", s.adminStateV1)
	mux.HandleFunc("PUT /v1/admin/settings", s.adminSettingsV1)
